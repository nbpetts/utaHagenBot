...
(function (root, factory) {
  ...
  annyang = {
    ...
    /**
     * toggle isRehearsing Bool.
     * returns isRehearsing.
     *
     */
    toggleIsRehearsing: function() {
      if (isRehearsing){
        isRehearsing = false;
      }
      else {
    ...
    /**
     * Returns true if Uta HagenBot is currently in rehersal mode.
     * Returns false if Uta is in some other mode.
     *
     */
